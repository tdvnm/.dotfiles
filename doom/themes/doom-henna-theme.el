...
;;; Local override with lightened grey palette.
;;; Code:
...
(def-doom-theme doom-henna
  "A dark theme inspired by VSCode's Henna theme (lightened greys)"

  ;; name        default   256       16
  ((bg         '("#2d3540" nil       nil            ))
   (bg-alt     '("#262c34" nil       nil            ))
   (base0      '("#1a2028" "black"   "black"        ))
   (base1      '("#222830" "#2e2e2e" "brightblack"  ))
   (base2      '("#262c34" "#262626" "brightblack"  ))
   (base3      '("#323b46" "#3f3f3f" "brightblack"  ))
   (base4      '("#363d4a" "#525252" "brightblack"  ))
   (base5      '("#3e4555" "#6b6b6b" "brightblack"  ))
   (base6      '("#535c6b" "#979797" "brightblack"  ))
   (base7      '("#6b7590" "#dfdfdf" "white"        ))
   (base8      '("#8fa0a5" "#1e1e1e" "brightblack"  ))
   (fg         '("#f8f8f0" "#bfbfbf" "brightwhite"  ))
   (fg-alt     '("#8f96a5" "#979797" "white"        ))
   (grey       '("#9aa5b8"))
